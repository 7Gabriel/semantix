...
def parseDeLogs():
    conf = SparkConf().setMaster("local").setAppName("TotalErro404")
...
if __name__ == "__main__":
    ...
    registroErro = dadosLogs.filter(lambda log: log.status==404).cache()
    print 'Total de erros 404: %d' % registroErro.count()
